...
<form action="news.php" method="GET">
	<select name=theme required>
		...
		<option value="2">Самолеты</option>
		<option value="3">Авиакомпании</option>
	</select>
...
while($nw=mysqli_fetch_assoc($news))
{
	...
	<div class="pagestyleone">
		<a href="pages/fullnews.php?id=<?php echo $nw['id']; ?>">
		<img src="<?php echo $nw['news_image']; ?>">
		<div class="pagetextone">
			<h2><?php echo $nw['news_name']; ?></h2>
			<?php
			$nw_th = false;
			foreach($theme as $th)
			{
			...
			?>
			<p><?php echo "Тема: ".$nw_th['theme']; ?></p>
			<?php echo mb_substr($nw['news_text'], 0, 200, 'utf8');?>...<br/>
		</div>
		</a>
	</div>
	<?php
